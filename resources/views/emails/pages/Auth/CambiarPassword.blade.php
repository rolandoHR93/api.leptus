                ...
                <center>
                    ...
                    <tr>
                        ...
                        <div><!--[if mso]>
                            ...
                            href="https://leptus-peru.netlify.app/reset-password/{{$email}}/{{$token}}" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#473FCE">
                            <w:anchorlock/>
                        ...
                        <![endif]--><a href="https://leptus-peru.netlify.app/reset-password/{{$email}}/{{$token}}"
