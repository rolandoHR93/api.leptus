...
<link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous"/>
		...
		<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
			...
			<div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
				<div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    ...
                    <svg class="svgAnimate" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="24px" height="30px" viewBox="0 0 24 30" style="enable-background:new 0 0 50 50;" xml:space="preserve">
                    ...
                    <h1 class="colorOrange">API - {{date('d/m/Y')}}
                    </h1>
				</div>
				...
				<div class="flex justify-center mt-4 sm:items-center sm:justify-between">
			        ...
			        <div class="ml-4 leading-7 font-semibold">
                        <a href="/api" class="underline text-gray-700">Api Home</a>
                    </div>
    ...
    <script>
        ...
        button_Login.addEventListener('click',  (event) => {
            ...
            document.getElementById('button_Login').innerHTML = 'Login <i class="fas fa-sync fa-spin" style="font-size:20px;"></i>'
